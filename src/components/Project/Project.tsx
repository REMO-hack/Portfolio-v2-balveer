        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Streamlined food ordering and logistics across college campuses
              </p>
            </div>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p> Matched students based on interests and schedules for peer-based learning.
              </p>
            </div>
         ...
         <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Digital Marketing Toolkit (Chrome Extension)</h3>
              <p>
             A productivity tool for marketers to manage campaigns and insights
              </p>
            </div>
